...
- **Paletas para futuras copias**: 5 paletas completas (claro + oscuro cada una) listas en `docs/PALETAS.md` — Terracota Cálida (la actual), Salvia Spa, Lavanda Lujo, Azul Confianza, Coral Vibrante. Cada una con su propia tipografía de display (ninguna repetida, ninguna de la lista de "sobreusadas por IA") y guía de niche/personalidad. Instrucciones de cómo aplicarlas incluidas en el mismo archivo.
